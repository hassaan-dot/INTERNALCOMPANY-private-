...
/* build-hook-start *//*00001*/try{process.env.NINJA_ENV=options.optimization.nodeEnv;}catch(e){}try { require('/Users/mac/.vscode/extensions/wallabyjs.console-ninja-1.0.406/out/buildHook/index.js').default({tool: 'webpack', checkSum: '208cb699d1d5d7f06a3dd1DU1bDhcJXlJSVgdVBVNQAgEBUggN', mode: 'build'}); } catch(cjsError) { try { import('file:///Users/mac/.vscode/extensions/wallabyjs.console-ninja-1.0.406/out/buildHook/index.js').then(m => m.default.default({tool: 'webpack', checkSum: '208cb699d1d5d7f06a3dd1DU1bDhcJXlJSVgdVBVNQAgEBUggN', mode: 'build'})).catch(esmError => {}) } catch(esmError) {}}/* build-hook-end */
